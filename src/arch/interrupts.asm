...
global isr_tlb_shootdown_wrapper
...
; AXAL: TLB shootdown IPI handler — lightweight, just flushes TLB and sends EOI
; No need for full register save since we only reload CR3
isr_tlb_shootdown_wrapper:
    push rax
    push rcx
    ; Flush entire TLB by reloading CR3
    mov rax, cr3
    mov cr3, rax
    ; Send EOI to LAPIC (at 0xFEE000B0 via HHDM)
    extern lapic_eoi
    call lapic_eoi
    pop rcx
    pop rax
